...
# ----------------- CONFIG -----------------
IMAGE_PATH = "images/grocery2.png"                          # path to your input image
...
def process_image(image_path):
    ...
    cv2.imshow("Local Detections", annotated)
    cv2.waitKey(0)
